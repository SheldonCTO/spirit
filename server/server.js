...
const productService = require("./Servers/productServer.js");
const csService = require("./Servers/csServer.js");
const storeService = require("./Servers/storeServer.js");
const orderService = require("./Servers/orderServer.js")
...
app.post("/api/register", (req,res)=>{
    csService.registerUser(req.body).then(msg=>{
